    ...
    <body>
        <div id="flex-top">
            ...
            <nav>
                ...
                <a id="secure-link" href="/w/assignment/secure_login.html">Secure loing</a>
        ...
        <main>
			...
			<svg id="svg">
				<text x="0" y="15" fill="white" transform="rotate(30 20, 40)">Security on the internet is cool!</text>
			</svg>
            </div>
